...
class AppStateNotifier extends ChangeNotifier {
  ReboundTherapyFirebaseUser? initialUser;
  ReboundTherapyFirebaseUser? user;
  ...
  void update(ReboundTherapyFirebaseUser newUser) {
    initialUser ??= newUser;
    user = newUser;
        ...
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              name: 'daily_reminder',
              path: 'dailyReminder',
              builder: (context, params) => DailyReminderWidget(),
            ),
            FFRoute(
              name: 'workouts',
              path: 'workouts',
            ...
            FFRoute(
              name: 'feedback_hub',
              path: 'feedbackHub',
              builder: (context, params) => FeedbackHubWidget(),
            )
